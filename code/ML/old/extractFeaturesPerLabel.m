function [ ] = extractFeaturesPerLabel( )

     sampleDir='../../data2/both_play_3/';
    d_sub=dir(sampleDir);
    isub = [d_sub(:).isdir];
    ...
    for j=1:length(instanceDir)
        ...
        if(exist(strcat(base_dir,'/data/phase3_data.mat'),'file') && ~exist(strcat(base_dir,'/data/feature_data.mat'),'file') )
